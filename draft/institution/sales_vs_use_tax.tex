...
In FY~2017, across that panel, use tax averaged 8.19\% of sales-plus-use
(median 8.22\%) and 2.77\% of all state tax. Sales tax was therefore about
92\% of the combined pot. FY~2010 is nearly identical. Shares vary by state
(examples: Michigan 14.8\%, Indiana 13.7\%, Iowa 16.7\%, Florida 2.7\%,
Hawaii 1.1\%).
