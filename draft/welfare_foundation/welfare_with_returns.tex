...
\subsection{First-order deadweight loss}
\label{sec:DWL}
...
revenue $\tau Q$ is transferred rather than lost.  Total surplus
$V=W+\tau Q$ therefore satisfies $dV/d\tau=\tau Q'(\tau)$, which is zero at
$\tau=0$.  Locally, a cost shock has a first-order welfare effect of $-Q$,
while an infinitesimal tax has none---the dollar is lost in one case and
merely transferred in the other.
