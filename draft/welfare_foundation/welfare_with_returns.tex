...
\label{cor:welfare-bias-buyer}
  ...
  $\mu_p\Lambda<1$.  The former cut is equivalent to
  \begin{equation}
    \varepsilon_r(p)\,
  ...
  \end{equation}
\end{corollary}
Relative to the pass-through cut $\varepsilon_r(p)<-p/(p+h)$ in
Result~\ref{res:pt-bias-er}, the return-rate elasticity is scaled by the
producer-incidence share $\varepsilon_D/(\varepsilon_D-\varepsilon_S)$.
